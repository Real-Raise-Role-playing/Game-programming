...
public class PhotonManager : Photon.MonoBehaviour
{
    ...
    //public static int staticTeamNum = 0;
    ...
    void OnJoinedRoom()
    {
        Debug.Log("룸접속");
        CreatePlayer();
        //ScenePhotonView.RPC("otherCreatePlayer", PhotonTargets.All, null);
    ...
    void CreatePlayer()
    {
        ...
        //PunTeams.PlayersPerTeam[] playersPerTeams = new PunTeams.PlayersPerTeam[];
        //PunTeams.PlayersPerTeam[PunTeams.Team.red] = null;
        //PunTeams.PlayersPerTeam[PunTeams.Team.blue] = null;
        //PunTeams.Team[] teams = { PunTeams.Team.red, PunTeams.Team.blue };
        ...
        if (PunTeams.PlayersPerTeam[PunTeams.Team.red].Count < PunTeams.PlayersPerTeam[PunTeams.Team.blue].Count)
        {
            ...
            PhotonNetwork.player.SetTeam(PunTeams.Team.red);
            //PhotonNetwork.playerList[PhotonNetwork.player.ID - 1].SetTeam(PunTeams.Team.red);
        }
